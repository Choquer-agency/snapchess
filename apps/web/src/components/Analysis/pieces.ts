// SVG chess piece paths — standard Merida-style outlines
// Each returns an SVG string to be rendered inline

const PIECES: Record<string, string> = {
  wk: `<g fill="#fff" stroke="#000" stroke-width="1.5" stroke-linejoin="round">
    <path d="M22.5 11.63V6" stroke-linecap="round"/>
    <path d="M20 8h5" stroke-linecap="round"/>
  ...
  wq: `<g fill="#fff" stroke="#000" stroke-width="1.5" stroke-linejoin="round">
    <circle cx="6" cy="12" r="2.75"/>
    <circle cx="14" cy="9" r="2.75"/>
    <circle cx="22.5" cy="8" r="2.75"/>
    <circle cx="31" cy="9" r="2.75"/>
    <circle cx="39" cy="12" r="2.75"/>
    <path d="M9 26c8.5-1.5 21-1.5 27 0l2.5-12.5L31 25l-3.5-7-5 6.5-5-6.5-3.5 7-7.5-11L9 26z" stroke-linecap="butt"/>
  ...
  wr: `<g fill="#fff" stroke="#000" stroke-width="1.5" stroke-linejoin="round">
    ...
    <path d="M12 35.5h21M13 31.5h19M14 29.5h17M14 16.5h17M11 14h23" fill="none" stroke="#000" stroke-linejoin="miter"/>
  </g>`,
  wb: `<g fill="#fff" stroke="#000" stroke-width="1.5" stroke-linejoin="round">
    <g stroke-linecap="butt">
      <path d="M9 36c3.39-.97 10.11.43 13.5-2 3.39 2.43 10.11 1.03 13.5 2 0 0 1.65.54 3 2-.68.97-1.65.99-3 .5-3.39-.97-10.11.46-13.5-1-3.39 1.46-10.11.03-13.5 1-1.354.49-2.323.47-3-.5 1.354-1.94 3-2 3-2z"/>
      <path d="M15 32c2.5 2.5 12.5 2.5 15 0 .5-1.5 0-2 0-2 0-2.5-2.5-4-2.5-4 5.5-1.5 6-11.5-5-15.5-11 4-10.5 14-5 15.5 0 0-2.5 1.5-2.5 4 0 0-.5.5 0 2z"/>
      <path d="M25 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 1 1 5 0z"/>
    </g>
    <path d="M17.5 26h10M15 30h15M22.5 15.5v5M20 18h5" fill="none" stroke="#000" stroke-linejoin="miter"/>
  </g>`,
  wn: `<g fill="#fff" stroke="#000" stroke-width="1.5" stroke-linejoin="round">
    <path d="M22 10c10.5 1 16.5 8 16 29H15c0-9 10-6.5 8-21"/>
    <path d="M24 18c.38 2.91-5.55 7.37-8 9-3 2-2.82 4.34-5 4-1.042-.94 1.41-3.04 0-3-1 0 .19 1.23-1 2-1 0-4.003 1-4-4 0-2 6-12 6-12s1.89-1.9 2-3.5c-.73-.994-.5-2-.5-3 1-1 3 2.5 3 2.5h2s.78-1.992 2.5-3c1 0 1 3 1 3"/>
    <path d="M9.5 25.5a.5.5 0 1 1-1 0 .5.5 0 1 1 1 0zM14.933 15.75a.5 1.5 30 1 1-.866-.5.5 1.5 30 1 1 .866.5z" fill="#000"/>
  </g>`,
  ...
  bq: `<g fill-rule="evenodd" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    ...
    <path d="M9 26c8.5-1.5 21-1.5 27 0l2.5-12.5L31 25l-3.5-7-5 6.5-5-6.5-3.5 7-7.5-11L9 26z" fill="#000" stroke-linecap="butt"/>
  ...
  br: `<g fill-rule="evenodd" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
  ...
  bb: `<g fill-rule="evenodd" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    <g fill="#000" stroke-linecap="butt">
      <path d="M9 36c3.39-.97 10.11.43 13.5-2 3.39 2.43 10.11 1.03 13.5 2 0 0 1.65.54 3 2-.68.97-1.65.99-3 .5-3.39-.97-10.11.46-13.5-1-3.39 1.46-10.11.03-13.5 1-1.354.49-2.323.47-3-.5 1.354-1.94 3-2 3-2z"/>
      <path d="M15 32c2.5 2.5 12.5 2.5 15 0 .5-1.5 0-2 0-2 0-2.5-2.5-4-2.5-4 5.5-1.5 6-11.5-5-15.5-11 4-10.5 14-5 15.5 0 0-2.5 1.5-2.5 4 0 0-.5.5 0 2z"/>
      <path d="M25 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 1 1 5 0z"/>
    </g>
    <path d="M17.5 26h10M15 30h15M22.5 15.5v5M20 18h5" fill="none" stroke="#fff" stroke-linejoin="miter"/>
  </g>`,
  ...
  bp: `<g fill-rule="evenodd" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    <path d="M22.5 9c-2.21 0-4 1.79-4 4 0 .89.29 1.71.78 2.38C17.33 16.5 16 18.59 16 21c0 2.03.94 3.84 2.41 5.03C15.41 27.09 11 31.58 11 39.5H34c0-7.92-4.41-12.41-7.41-13.47C28.06 24.84 29 23.03 29 21c0-2.41-1.33-4.5-3.28-5.62.49-.67.78-1.49.78-2.38 0-2.21-1.79-4-4-4z" fill="#000"/>
  </g>`,
};
...
// Returns a complete SVG data URI for use in <img> tags
export function getPieceSvgDataUri(piece: string): string {
  const svg = PIECES[piece];
  if (!svg) return '';
  const full = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">${svg}</svg>`;
